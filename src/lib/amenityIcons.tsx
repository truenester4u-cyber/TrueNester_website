...
export const amenityIconMap: Record<string, LucideIcon> = {
  ...
  "steam room": Droplets,
  "jacuzzi": Waves,
  "yoga studio": HeartPulse,
  "pilates studio": HeartPulse,
  "spinning studio": Dumbbell,
  "aerobics room": Dumbbell,
  "boxing ring": Dumbbell,
  "martial arts room": Dumbbell,
  "dance studio": Users,
  "meditation room": HeartPulse,
  "prayer room": Church,
  "therapy room": HeartPulse,
  "massage room": HeartPulse,
  "kids play area": Baby,
  ...
  "ping pong table": GamepadIcon,
  "cricket pitch": GamepadIcon,
  "football field": GamepadIcon,
  "volleyball court": GamepadIcon,
  "badminton court": GamepadIcon,
  "padel court": GamepadIcon,
  "muga court": GamepadIcon,
  "climbing wall": GamepadIcon,
  "skate park": GamepadIcon,
  "billiards room": GamepadIcon,
  "card room": GamepadIcon,
  "game room": GamepadIcon,
  "golf course": Trees,
  "golf course view": Trees,
  ...
  "beauty salon": HeartPulse,
  "barber shop": Users,
  "nail salon": HeartPulse,
